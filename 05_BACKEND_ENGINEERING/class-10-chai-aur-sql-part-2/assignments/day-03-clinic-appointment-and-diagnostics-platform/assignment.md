...
- **Understanding of Workflow (15 marks):** Did the student understand the clinic flow from appointment to consultation to diagnostics?
- **Entity Identification (20 marks):** Are patient, doctor, appointment, consultation, diagnostic test, and report structures captured properly?
- **Relationship Modeling (20 marks):** Are patient-doctor-appointment-test-report relations meaningful and correct?
- **PK/FK Quality (15 marks):** Are links between records well designed?
- **Attribute Design (15 marks):** Are relevant attributes included without stuffing too much into one entity?
- **Business Logic Accuracy (10 marks):** Does the design make sense for a real clinic system?
- **Diagram Presentation (5 marks):** Is the ERD clean and easy to review?
