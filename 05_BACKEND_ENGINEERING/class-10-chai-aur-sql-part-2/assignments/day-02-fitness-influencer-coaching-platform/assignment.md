...
- **Business Understanding (15 marks):** Did the student understand the difference between coaching, plans, sessions, and progress tracking?
- **Entity Design (20 marks):** Are the core entities captured properly? Did they identify trainers, clients, subscriptions, plans, sessions, check-ins, and progress?
- **Relationships and Cardinality (20 marks):** Are trainer-client, plan-client, and session-client relationships modeled correctly?
- **Attributes and Data Separation (15 marks):** Are user details, plan details, and progress data separated properly?
- **PK/FK Design (15 marks):** Are keys properly assigned and linked?
- **Practicality of the Model (10 marks):** Does the model feel usable in a real coaching platform?
- **Diagram Quality (5 marks):** Is the ER diagram neat and readable?
