...
- Class Name: Intro to Backend Engineering

---

## Notes

- Visual Diagram -> [Open Diagram](https://app.eraser.io/workspace/9JvrGBqW7GCartZeb63v)
- Visual Diagram -> [Open Diagram](https://link.excalidraw.com/readonly/twcMhFTurtFzNlryDVil?darkMode=true)
